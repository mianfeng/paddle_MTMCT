...
class PipePredictor(object):
    ...
    def run(self, input, thread_idx=0,threadQueue=None,frameQueue=None):
        if self.is_video:
            self.predict_video(input, thread_idx=thread_idx,threadQueue=threadQueue,frameQueue=frameQueue)
        else:
    ...
    def predict_video(self, video_file, thread_idx=0,threadQueue=None,frameQueue=None):
        # mot
        # mot -> attr
        # mot -> pose -> action
